...
path <- paste0('./param_for_search/p_', log_p, '/batch_', batch_n, '/L0_', log_L0, '_L2_', log_L2, '/')
...
path <- paste0('./results_of_search/p_', log_p, '/batch_', batch_n, '/L0_', log_L0, '_L2_', log_L2, '/')
